...
<main id="main" class="main">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <!-- Horizontal Form -->
            <form method="POST" action="{{ route('opds.update', $opd->id) }}">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                    <label for="opd_name" class="col-sm-2 col-form-label">OPD Name</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="opd_name" name="opd_name" value="{{ $opd->opd_name }}" required>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" id="description" name="description">{{ $opd->description }}</textarea>
