                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" id="statustgr_id" name="statustgr_id" value="{{ $defaultStatustgr->id }}">
                                <input type="text" class="form-control" value="{{ $defaultStatustgr->tgr_name }}" disabled>
                            </div>
