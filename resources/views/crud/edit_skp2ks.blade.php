    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('skp2ks.update', $temuan->id) }}" method="POST" enctype="multipart/form-data" id="editTemuanForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="no_skp2ks">No SKP2Ks</label>
                                <input type="text" class="form-control" id="no_skp2ks" name="no_skp2ks" value="{{ $temuan->no_skp2ks }}">
                            </div>
