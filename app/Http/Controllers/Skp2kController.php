...
class Skp2kController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            'no_skp2k' => 'required|string|max:255',
        ...
        $temuan->no_skp2k = $request->input('no_skp2k');
    ...
    public function edit($id)
    {
        ...
        $pegawais = Pegawai::all();
        $penyedias = Penyedia::all();
        return view('crud.edit_skp2k', compact('temuan', 'informasis', 'opds', 'statuses', 'statustgrs', 'pegawais', 'penyedias'));
    }
    ...
    public function update(Request $request, $id)
    {
        $request->validate([
            ...
            'temuan' => 'required|string',
            'rekomendasi' => 'required|string',
            'no_skp2k' => 'required|string|max:255', // Pastikan ini sesuai dengan struktur tabel Anda
            'jumlah_jaminan' => 'nullable|numeric',
            'jenis_jaminan' => 'nullable|string|max:255',
            'nilai_rekomendasi' => 'required|numeric',
        ...
        $temuan->temuan = $request->input('temuan');
        $temuan->rekomendasi = $request->input('rekomendasi');
        $temuan->no_skp2k = $request->input('no_skp2k'); // Pastikan ini sesuai dengan nama kolom di tabel
        $temuan->jumlah_jaminan = $request->input('jumlah_jaminan');
        $temuan->jenis_jaminan = $request->input('jenis_jaminan');
        $temuan->nilai_rekomendasi = $request->input('nilai_rekomendasi');
        ...
        $temuan->save();
        return redirect()->route('skp2k.index')->with('success', 'Data berhasil diperbarui');
    }
    /*
    *
